...
public class DeviceRegisterTask extends CallbackAsyncTask<Object, Void, String>
{
    public DeviceRegisterTask(final Context context, final AsyncTaskCompleteListener<String> asyncTaskCompleteListener) {
    ...
    protected String doInBackground(final Object... array) {
        ...
        try {
            clipbrdClient.registerDevice(s);
            return null;
        }
        catch (Exception ex) {
